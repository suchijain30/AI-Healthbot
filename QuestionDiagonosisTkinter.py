...
training_dataset = pd.read_csv('ai_healthbot\Training.csv')
test_dataset = pd.read_csv('ai_healthbot\Testing.csv')
...
doc_dataset = pd.read_csv('ai_healthbot\doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="suchi jain ", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
